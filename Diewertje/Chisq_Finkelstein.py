...
def calc_Chi_square(parameters,xdata,ydata,yerr,guide_length=20,
                    model_id='general_energies'):
    # concentrations in nMolair
    # reference = 1 nMolair
    mABA=ABA.calc_ABA(parameters, concentrations, reference, xdata, model_id = 'general_energies', guide_length = 20, T=10*60)
    Chi_square=0
