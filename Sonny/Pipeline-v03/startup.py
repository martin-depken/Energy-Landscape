...
def main(argv):
	...
	if False: # this is the option to take if the file contains the final parameters only
	...
	else: # this is the option to take if you use the raw output of the fitting process
