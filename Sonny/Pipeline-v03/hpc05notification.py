...
def hpc05notification(variable,stage="final",PS=""):
	...
	if stage == "milestone":
		msg['Subject'] = "HPC05 Milestone! - "+variable[2]
		_to   = ["hpc05notification@gmail.com"]
		body = "Lectori salutem,\n\nThe HPC05 cluster has passed a milestone of your request at " + time.strftime("%H")+":"+time.strftime("%M")+"h. It is currently at position "+variable[0]+" of "+variable[1]+".\nPlease, await the result until further instruction.\n\nYours faithfully,\nHPC05"
	else:		
		msg['Subject'] = "HPC05 Finished! - "+variable[1]
		_to   = ["hpc05notification@gmail.com"]
		body = "Lectori salutem,\n\nThe HPC05 cluster has finished your request. It took "+str(variable[0])+" seconds.\nPlease, study the result at your earliest convenience.\n\nYours faithfully,\nHPC05"
